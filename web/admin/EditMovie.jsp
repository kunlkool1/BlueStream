                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="custom-select tm-select-accounts" id="category" name="license" required>
                                            ...
                                            <option value="1" ${detail.license.equals("License") ? "selected" : ""}>License</option>
                                            <option value="0" ${detail.license.equals("No License") ? "selected" : ""}>No License</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-3 col-xs-12 col-sm-6 mx-auto">
                                            ...
                                            <select class="custom-select tm-select-accounts" id="category" name="movieStatus" required>
                                                <option value="1" ${detail.movieStatus.equals("Finish") ? "selected" : ""}>Finished</option>
                                                <option value="0" ${detail.movieStatus.equals("Not Yet") ? "selected" : ""}>Not Yet</option>
                                            </select>
                                        </div>
                                        <div class="form-group mb-3 col-xs-12 col-sm-6 mx-auto">
