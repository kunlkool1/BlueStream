                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <div class="anime__details__pic set-bg">
                                <img style="width: 400px; height: 250px; border-radius: 1000px" src="${account.image}z" alt="avatar"
                                            ...
                                            <div
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <input type="file" name="avatar_pic" accept="image/gif, image/jpeg, image/png">
                                                    </div>
                                                </div>
