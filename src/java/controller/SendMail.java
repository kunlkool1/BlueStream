...
public class SendMail {
    ...
    public static void sendMail(String emailTo, String money, String type) {
        ...
        try {
            ...
            String subject = "Thank you for "+ type;
            
            String detail = "We received "+ money +"VND you "+ type +" to BlueStream. You are wonderfull. Thank for being part of us.";
            
            String action = "You have " + type + " successfully";
