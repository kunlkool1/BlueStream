...
public class AccountDAO {
    ...
    public void insertWithIDGoogle(Account a) throws Exception {
        ...
        try {
            ...
            String userName1 = email.substring(0, Math.min(email.length(), 5));
    ...
    public void updateRole(String userID, int role) {
        try {
            String query = "update \"tbAccount\" \n"
                    + "set \"Role\" = " + role + "\n"
                    + "where \"UserID\" = '" + userID + "'";
    ...
    public ArrayList<Account> getAllAccountByName(String name) {

        ArrayList<Account> list = new ArrayList<>();
        String query = "select * from \"tbAccount\" where \"UserName\" like '%" + name + "%' ";
    ...
    public Account getAccountByID(String id) {
        ...
        String query = "select * from \"tbAccount\" where \"UserID\" = '" + id + "'";
        ...
        try {
            ...
            while (re.next()) {
                ...
                int Role = re.getInt("Role");
                String user_id_google = re.getString("user_id_google");
                Account a = new Account(UserID, UserName, Password, Email, FullName, yearOfBirth, Phone, img, Role, user_id_google);
                return a;
            }
        } catch (Exception e) {
        } finally {
    ...
    public Account getAccountByEmail(String email) {
        ...
        String query = "select * from \"tbAccount\" where \"Email\" = '" + email+ "'";
    ...
    public void deleteAccount(String userID) {
        String query = "delete from \"tbHistory\" where \"UserID\" = '"+userID+"';\n"
                + "delete from \"tbFavorite\" where \"UserID\" = '"+userID+"';\n"
                + "delete from \"tbComment\" where \"UserID\" = '"+userID+"';\n"
                + "update \"tbPayment\" \n"
                + "set \"UserID\" = 'd0b27f45-f360-4b7a-9ddf-973edca63ee1'\n"
                + " where \"UserID\" = '"+userID+"';\n"
                + " delete from \"tbAccount\" where \"UserID\" = '"+userID+"'";
        try {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ac.getAccountByEmail("bluestream123a@gmail.com").toString());
    }
}
